...
from face_detection_utils import detect_face, extract_face
...
class PNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = 'checkpoint/pnet.pt'
...
class RNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = 'checkpoint/rnet.pt'
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
...
class ONet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = 'checkpoint/onet.pt'
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
